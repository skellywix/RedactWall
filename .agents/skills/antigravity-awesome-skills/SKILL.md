...
description: A curated community library of 1,200+ universal SKILL.md skills (brainstorming, architecture, debugging, api-design, security-auditor, create-pr, doc-coauthoring) installable in one command across Codex/Cursor/Codex. Use to pull battle-tested skills instead of writing them from scratch. Wraps the external library.
---
