...
> PromptSentinel already keeps long-form history in `ITERATIONS.md` and `REVIEW.md`. Treat those as the archive; PLAN/STATUS/DECISIONS are the live working set. Don't duplicate — link.
