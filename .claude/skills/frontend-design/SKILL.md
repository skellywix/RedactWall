...
- **Dashboard** (`public/index.html`): detections over time, top PII categories, top destinations, pending approvals — information-dense, scannable.
...
- **Login** (`public/login.html`): minimal, reassuring, no marketing.
