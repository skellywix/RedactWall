...
description: Unified agent access to 50+ Google Workspace APIs (Gmail, Drive, Docs, Sheets, Calendar, Chat) via the gws CLI + its built-in MCP server. For RedactWall, use it to assemble compliance evidence into Sheets/Docs, draft examiner-facing reports, and route alerts to Chat. Wraps the external gws tool.
---
