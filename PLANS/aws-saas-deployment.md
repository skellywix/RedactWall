...
PromptSentinel is moving from local pilot software toward a hosted SaaS offer.
...
Each paying customer gets an isolated AWS stack running one PromptSentinel
