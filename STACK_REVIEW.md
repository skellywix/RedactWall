...
| Frontend dashboard | Vite + React + TypeScript app (`console/`), built to `server/public/app/` and served auth-gated at `/app` | Keep | The static vanilla-JS console was retired on 6 July 2026 (see the update banner above) once the React console reached parity. The shared design system, strict CSP, and login page carry over. |
