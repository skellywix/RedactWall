...
function buildPack(argv, contents, existing) {
  ...
  // A CSV --column projects one roster column into the same {value, line}
  // shape line-oriented input uses, so eligibility validation and duplicate
  // dedup stay identical. valuesFromCsv already trims and drops empties.
...
module.exports = {
  buildPack, compatibleProfile, inputValues, main, validateValues, parseCsvLine, valuesFromCsv,
};
