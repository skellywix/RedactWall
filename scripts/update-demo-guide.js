...
const SENSOR_AND_DOC_PATHS = [
  ...
  ['console/src/App.tsx', 'React admin console shell'],
  ...
  ['sensors/mcp-guard/connectors/google-drive.js', 'Google Drive MCP file-content connector'],
  ['sensors/mcp-guard/connectors/slack.js', 'Slack MCP conversation and file-content connector'],
  ['sensors/mcp-guard/connectors/teams.js', 'Microsoft Teams MCP message connector'],
  ['sensors/mcp-guard/connectors/atlassian.js', 'Atlassian Jira and Confluence MCP connector'],
  ['sensors/mcp-guard/connectors/database-readonly.js', 'Database read-only MCP connector'],
