...
const ENV_ALIASES = [
  ...
  ['SENTINEL_LICENSE_PATH', 'PROMPTWALL_LICENSE_PATH'],
  ['SENTINEL_LICENSE_PUBLIC_KEY', 'PROMPTWALL_LICENSE_PUBLIC_KEY'],
  ...
  ['SENTINEL_DATA_KEY_PREVIOUS', 'PROMPTWALL_DATA_KEY_PREVIOUS'],
  ['SENTINEL_DB_DRIVER', 'PROMPTWALL_DB_DRIVER'],
  ['SENTINEL_DATABASE_URL', 'PROMPTWALL_DATABASE_URL'],
  ['SENTINEL_SEMANTIC_REMOTE_URL', 'PROMPTWALL_SEMANTIC_REMOTE_URL'],
  ['SENTINEL_SEMANTIC_REMOTE_KEY', 'PROMPTWALL_SEMANTIC_REMOTE_KEY'],
  ['SENTINEL_SEMANTIC_REMOTE_TIMEOUT_MS', 'PROMPTWALL_SEMANTIC_REMOTE_TIMEOUT_MS'],
