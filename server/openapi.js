...
const RESPONSES = {
  ...
  HeartbeatResponse: openObject({ id: { type: 'string' }, decision: { type: 'string' }, status: { type: 'string' }, failedChecks: { type: 'array', items: { type: 'string' } }, companions: { type: 'array', items: { type: 'string' } } }),
  DiscoveryResponse: openObject({ status: { type: 'string' }, imported: { type: 'integer' }, observations: { type: 'integer' }, destinations: { type: 'array', items: { type: 'string' } } }),
