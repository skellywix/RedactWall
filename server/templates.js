 ...
 */
const ALL_PII = ['US_SSN', 'CREDIT_CARD', 'BANK_ACCOUNT', 'ROUTING_NUMBER', 'IBAN', 'US_PASSPORT', 'US_TIN_EIN', 'US_DRIVERS_LICENSE', 'SECRET_KEY', 'PRIVATE_KEY', 'CANARY_TOKEN', 'PASSWORD', 'DOB'];
...
const TEMPLATES = {
  baseline: {
    ...
    policy: { enforcementMode: 'block', blockMinSeverity: 3, blockRiskScore: 30,
      alwaysBlock: ['US_SSN', 'CREDIT_CARD', 'BANK_ACCOUNT', 'ROUTING_NUMBER', 'IBAN', 'US_PASSPORT', 'SECRET_KEY', 'PRIVATE_KEY', 'CANARY_TOKEN'], disabledDetectors: [] },
  },
  ncua_glba: {
    ...
    policy: { enforcementMode: 'block', blockMinSeverity: 2, blockRiskScore: 20,
      alwaysBlock: ['US_SSN', 'CREDIT_CARD', 'BANK_ACCOUNT', 'ROUTING_NUMBER', 'IBAN', 'US_PASSPORT', 'US_TIN_EIN', 'US_DRIVERS_LICENSE', 'DOB', 'SECRET_KEY', 'PRIVATE_KEY', 'CANARY_TOKEN'], disabledDetectors: [] },
  },
  pci_dss: {
  ...
  hipaa: {
    ...
    policy: { enforcementMode: 'block', blockMinSeverity: 2, blockRiskScore: 20,
      alwaysBlock: ['US_SSN', 'US_DRIVERS_LICENSE', 'US_PASSPORT', 'DOB', 'BANK_ACCOUNT', 'CREDIT_CARD', 'SECRET_KEY', 'PRIVATE_KEY', 'CANARY_TOKEN'], disabledDetectors: [] },
  },
  redact_first: {
    ...
    policy: { enforcementMode: 'redact', blockMinSeverity: 2, blockRiskScore: 20,
      alwaysBlock: ['US_SSN', 'CREDIT_CARD', 'BANK_ACCOUNT', 'ROUTING_NUMBER', 'SECRET_KEY', 'PRIVATE_KEY', 'CANARY_TOKEN'], disabledDetectors: [] },
  },
};
