...
test('valuesFromCsv rejects non-positive and unsafe numeric indexes', () => {
  assert.throws(() => edm.valuesFromCsv('value', '0'), /positive integer/);
  assert.throws(() => edm.valuesFromCsv('value', '999999999999999999999'), /positive integer/);
});
